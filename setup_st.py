...
def set_design():
    ...
    with col2:
        ...
        st.image("pngtree-user-vector-avatar-png-image_1541962.png", use_column_width=True)

    # Adding a title to the Streamlit app, center-aligned
    st.markdown("<p style='text-align: center; font-size: 30px;'><b>[Ramesh Generative AI Chatbot]</b></p>", unsafe_allow_html=True)
